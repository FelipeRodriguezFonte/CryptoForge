...
public class ModernMainController implements StatusReporter {
    ...
    private File chooseSaveFile(String title, String suggestedFileName) {
        FileChooser fileChooser = new FileChooser();
        fileChooser.setTitle(title);
                        ...
                        .setExclusionStrategies(new com.google.gson.ExclusionStrategy() {
                            ...
                            public boolean shouldSkipField(com.google.gson.FieldAttributes f) {
                                return f.getName().equals("uiState")
                                        && f.getDeclaringClass() == com.cryptocarver.model.HistoryItem.class;
                            }
    ...
    private void handleSymmetricEncryptFile() {
        ...
        File outputFile = chooseSaveFile("Save Encrypted File As", inputFile.getName() + ".enc");
        if (outputFile == null) {
            return;
        }
    ...
    private void handleSymmetricDecryptFile() {
        ...
        File outputFile = chooseSaveFile("Save Decrypted File As", outputName);
        if (outputFile == null) {
            return;
        }
